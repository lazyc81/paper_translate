...
from vila.utils import union_lp_box, assign_tokens_to_blocks
from vila.pdftools.base import BasePDFTokenExtractor
from vila.pdftools.datamodel import PageData
...
def load_page_data_from_dict(source_data: Dict[str, Any]) -> List[Dict]:
    ...
    for page_token in page_data:
        page_token.lines = page_token.get_lines(y_tolerance = 8)
